...
- **JavaScript (Vanilla)** – Page interactivity and core logic

## 🚀 Features

- 🛍️ **Homepage** with mock product listings  
- 🛒 **Add to Cart** functionality  
- 💵 **Reliable price calculation** based on quantity  
- 📦 **Checkout flow** simulation  
- 📜 **Order history and tracking** pages  
- 🖥️ Entirely **frontend-based**, no backend or database  
